-- Fix the accept_bootstrap_admin function to handle the foreign key constraint properly
...
-- Also check if there are any missing functions that might be referenced
