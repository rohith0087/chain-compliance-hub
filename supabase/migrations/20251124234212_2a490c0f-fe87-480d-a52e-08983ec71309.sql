-- Fix handle_new_user() trigger to remove user_invitations dependency
-- This trigger was failing because it tried to query the deleted user_invitations table
