      ...
      <section className="relative bg-gradient-hero py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <Badge className="mb-6 px-4 py-2 bg-primary text-primary-foreground border-0 shadow-elegant">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Button 
                ...
                size="lg" 
                className="px-8 py-4 text-lg bg-gradient-primary text-white border-0 shadow-elegant hover:shadow-subtle transition-all duration-300 transform hover:scale-105"
              >
                Start Free Trial
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20">
            {stats.map((stat, index) => (
              <div key={index} className="text-center p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 hover:shadow-subtle transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {advancedFeatures.map((feature, index) => {
              ...
              return (
                <Card key={index} className="relative p-8 shadow-lg hover:shadow-elegant transition-all duration-300 group">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              onClick={() => navigate('/auth')}
              size="lg" 
              className="px-8 py-4 text-lg font-semibold bg-white text-primary hover:bg-white/90 transition-all duration-300 transform hover:scale-105 border-0"
            >
