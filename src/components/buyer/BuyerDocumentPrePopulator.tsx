      ...
      <div className={reviewCardContainerClass}>
                    ...
                    {file.documentType && matchingRequests.length > 0 && (
                      <div className="flex items-start gap-2 p-2 rounded-md bg-primary/10 border border-primary/20">
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          >
                            <SelectTrigger className="h-7 text-xs bg-card dark:bg-background">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            rows={2}
            className="resize-none text-sm rounded-[14px] border-border"
          />
        </div>

        {/* Progress */}
        {progress && (
          <div className="space-y-2 p-3 rounded-[16px] bg-muted/50 border border-border">
            <div className="flex items-center justify-between">
