-- Drop and recreate platform admin password reset function with email integration
DROP FUNCTION IF EXISTS platform_admin_reset_password(uuid);
...
BEGIN
  ...
  -- Call the edge function to send email (will be created next)
