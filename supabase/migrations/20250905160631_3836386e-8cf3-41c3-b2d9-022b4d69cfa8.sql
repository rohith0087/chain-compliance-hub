-- Function to create onboarding notifications
...
CREATE TRIGGER trigger_onboarding_notification
  AFTER INSERT ON supplier_onboarding_requests
  FOR EACH ROW
  EXECUTE FUNCTION create_onboarding_notification();